...
TASK_TOOL_DESCRIPTION = """Launch a configured Linko AI subagent to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured Linko AI subagent asynchronously.
